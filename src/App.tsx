...
import { LeetCodeCatalogPage } from "@/pages/LeetCodeCatalogPage";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <Routes>
        ...
        {/* LeetCode section: its own list + per-problem detail, reusing the
            same player host. Adding a problem never touches routing. */}
