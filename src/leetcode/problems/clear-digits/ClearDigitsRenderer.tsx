...
export function ClearDigitsRenderer({ step }: RendererProps<ClearDigitsData>) {
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-7">
      ...
      <div className="flex flex-col items-center gap-2">
        <span className="text-xs font-medium uppercase tracking-wide text-muted-foreground">letter stack</span>
      ...
      <Legend items={[{ role: "current", label: "Letter pushed" }, { role: "compared", label: "Digit (pops left)" }, { role: "visited", label: "Processed" }]} />
    </div>
  );
}
